...
<div class="card">
    ...
    <p style="color:#9ca3af;">This is your client web dashboard.</p>
</div>

<div class="card">
    <h2>Latest Wallet Requests</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6">No wallet requests found.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
