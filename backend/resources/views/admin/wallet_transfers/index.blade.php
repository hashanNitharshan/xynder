...
<style>
:root{--dark:#0B0E11;--hero:#181A20;--box:#181A20;--panel:#1E2329;--input:#0B0E11;--line:#2B3139;--red:#F0B90B;--red2:#C99400;--green:#0ecb81;--gold:#FFD45A;--text:#fff;--muted:#848E9C;--muted2:#5e6673;--shadow:0 18px 45px rgba(0,0,0,.35);}
*{box-sizing:border-box}
.ad-page{margin:-28px;min-height:100vh;background:var(--dark);color:var(--text);font-family:'Inter',-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif;padding:24px 36px 48px;}
.ad-hero{background:radial-gradient(circle at 92% 0%,rgba(240,185,11,.20),transparent 38%),linear-gradient(135deg,#181A20,#0B0E11);padding:18px 20px;position:relative;overflow:hidden;border:1px solid var(--line);border-radius:16px;margin:0 0 20px;box-shadow:var(--shadow);}
...
.ad-title-main{font-size:19px;line-height:1.2;font-weight:800;margin:0;color:#fff;}
.ad-title-main span{color:var(--red);display:inline;}
.ad-subtitle{color:var(--muted);font-size:13.5px;line-height:1.7;font-weight:700;max-width:580px;}
...
.ad-kpi{background:var(--box);border:1px solid var(--line);border-radius:10px;padding:20px;min-height:118px;position:relative;overflow:hidden;}
...
.ad-kpi-icon{width:42px;height:42px;border-radius:50%;background:rgba(240,185,11,.12);color:var(--red);border:1px solid rgba(240,185,11,.35);display:flex;align-items:center;justify-content:center;font-size:22px;margin-bottom:14px;}
...
.ad-card{background:var(--box);border:1px solid var(--line);border-radius:14px;overflow:hidden;box-shadow:var(--shadow);}
...
.ad-title{font-size:13.5px;font-weight:900;margin:0;display:flex;align-items:center;gap:9px;}
...
.ad-input,.ad-select{width:100%;height:42px;border:1px solid var(--line);border-radius:9px;padding:0 13px;font-size:13px;background:var(--input);color:var(--text);outline:0;font-weight:700;}
.ad-search-wrap .ad-input{padding-left:36px;}
.ad-input:focus,.ad-select:focus{border-color:var(--red);box-shadow:0 0 0 3px rgba(240,185,11,.12);}
.ad-btn{display:inline-flex;align-items:center;justify-content:center;gap:7px;padding:10px 13px;border-radius:9px;font-size:12px;font-weight:900;border:0;cursor:pointer;text-decoration:none;white-space:nowrap;}
...
.ad-click-row:hover td{background:var(--panel);}
...
.ad-wallet{display:inline-flex;align-items:center;gap:5px;margin-top:5px;padding:4px 8px;border-radius:20px;background:rgba(240,185,11,.12);color:var(--red);border:1px solid rgba(240,185,11,.35);font-size:11px;font-weight:900;}
...
@media(max-width:1100px){.ad-kpis{grid-template-columns:repeat(2,1fr);}.ad-filters{grid-template-columns:1fr 1fr;}.ad-table,.ad-table thead,.ad-table tbody,.ad-table th,.ad-table td,.ad-table tr{display:block;width:100%!important;}.ad-table thead{display:none;}.ad-table tr{background:var(--panel);border:1px solid var(--line);border-radius:14px;margin:12px;padding:14px;}.ad-table td{border-top:0;padding:9px 0;}.ad-table td::before{content:attr(data-label);display:block;color:var(--muted2);font-size:10px;font-weight:900;text-transform:uppercase;margin-bottom:5px;}.ad-table td:first-child::before{display:none;}}
